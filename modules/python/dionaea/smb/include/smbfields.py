...
class SMB_Negociate_Protocol_Response(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(UnicodeNullField(
            "OemDomainName", "NewTech Company"), lambda x: not x.Capabilities & CAP_EXTENDED_SECURITY),
        # In [MS-SMB].pdf page 49,
        # "ServerName" field needed for case without CAP_EXTENDED_SECURITY
        ConditionalField(UnicodeNullField(
            "ServerName", "Root-Server"), lambda x: not x.Capabilities & CAP_EXTENDED_SECURITY),
